/**
 * Originex VPC Module
 * Creates a production-grade VPC with 3-AZ subnets (public, private, data)
 */
...
# ─── Public Subnets (ALB, NAT Gateway, Istio Ingress) ───
...
# ─── Private Subnets (EKS worker nodes, Kafka, Flink) ───
